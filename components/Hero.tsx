...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative w-full min-h-[90vh] flex flex-col justify-center bg-[#f3f3f3] overflow-hidden border-b-4 border-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 flex flex-col justify-center">
            ...
            <motion.h1 
              className="text-7xl sm:text-8xl md:text-9xl font-black leading-[0.85] tracking-tighter mb-8"
              initial={{ opacity: 0, x: -50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.2, duration: 0.5 }}
            >
              I BUILD<br />
              <span className="text-transparent stroke-text" style={{ WebkitTextStroke: '3px black' }}>LANDING</span><br />
              PAGES.
            </motion.h1>
            
            <motion.p 
              className="text-xl md:text-2xl font-mono max-w-2xl border-l-4 border-black pl-6 py-2 mb-10 bg-white shadow-hard"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          <div className="lg:col-span-4 hidden lg:flex items-center justify-center">
            <motion.div 
              className="w-full aspect-square bg-white border-4 border-black shadow-hard-xl flex items-center justify-center relative overflow-hidden"
            ...
            >
                ...
                <div className="text-center transform rotate-12">
                   ...
                   <div className="text-9xl font-black opacity-10 select-none">JS</div>
                </div>
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center font-mono font-bold bg-white border-2 border-black p-4 shadow-hard">
